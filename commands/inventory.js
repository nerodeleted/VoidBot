...
exports.run = async (client, message, args) => {
  try {
    ...
    const embed = new Discord.MessageEmbed()
      ...
      .addField(`🌿 Weed`, client.inventory.get(key, 'weed') + ' weeds')
      .addField(`⬜ Acid`, client.inventory.get(key, 'acid') + ' acids')
      .addField(`💊 Cocaine`, client.inventory.get(key, 'cocaine') + ' cocaines')

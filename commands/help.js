  ...
  try {
    if (!args[0]) {
      const embed = new Discord.MessageEmbed()
				...
				.addField('Need more assistance?', '[Click here to join the official Void Bot support server](https://discord.gg/hDJvzvE8Mg)')
				.setImage("https://media.discordapp.net/attachments/796810115189178372/798672492561825802/Screenshot_20210101-2225592.png")

...
module.exports = async (client) => {
  const statusList = [
    { msg: "http://voidparadise.cf/", type: "PLAYING" },
  ...
  /* setInterval(async () => {
    ...
    client.logger.log("Running VoidBot v1.1 | http://voidparadise.cf/");
    client.startuptime = new Date().getTime() - client.starttime;
    client.logger.log("It took " + client.startuptime + "ms to start Void Bot.");
